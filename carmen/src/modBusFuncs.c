...
//	-1: fatal error
//***************************************************************************
int SendModBus(int fd, char dev_addr, char *buffer, int buffer_size, int num_bytes, int retry) {
    ...
    num_bytes_send = SendSerialPort(fd, modbus_buffer, modbus_buffer_size, 1 + num_bytes + 2, retry);
...
//	-1: fatal error
//************************************************************************** 
int ReceiveModBus(int fd, char dev_addr, char *buffer, int buffer_size, int num_bytes, int retry) {
    ...
    num_bytes_recv = ReceiveSerialPort(fd, modbus_buffer, modbus_buffer_size, 1 + num_bytes + 2, retry);
