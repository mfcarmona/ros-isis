...
(cl:in-package new_stage_isis-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <Range>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Range)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name new_stage_isis-msg:<Range> is deprecated: use new_stage_isis-msg:Range instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <Range>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader new_stage_isis-msg:header-val is deprecated.  Use new_stage_isis-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'radiation_type-val :lambda-list '(m))
(cl:defmethod radiation_type-val ((m <Range>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader new_stage_isis-msg:radiation_type-val is deprecated.  Use new_stage_isis-msg:radiation_type instead.")
  (radiation_type m))

(cl:ensure-generic-function 'field_of_view-val :lambda-list '(m))
(cl:defmethod field_of_view-val ((m <Range>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader new_stage_isis-msg:field_of_view-val is deprecated.  Use new_stage_isis-msg:field_of_view instead.")
  (field_of_view m))

(cl:ensure-generic-function 'min_range-val :lambda-list '(m))
(cl:defmethod min_range-val ((m <Range>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader new_stage_isis-msg:min_range-val is deprecated.  Use new_stage_isis-msg:min_range instead.")
  (min_range m))

(cl:ensure-generic-function 'max_range-val :lambda-list '(m))
(cl:defmethod max_range-val ((m <Range>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader new_stage_isis-msg:max_range-val is deprecated.  Use new_stage_isis-msg:max_range instead.")
  (max_range m))

(cl:ensure-generic-function 'range-val :lambda-list '(m))
(cl:defmethod range-val ((m <Range>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader new_stage_isis-msg:range-val is deprecated.  Use new_stage_isis-msg:range instead.")
  (range m))
